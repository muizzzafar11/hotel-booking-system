...
async def bookRoom(req: BookRequest):
    ...
    cursor.execute("INSERT INTO booking (room_number, checkin_date, checkout_date, ssn_customer) VALUES (%s, %s, %s, %s)", (req.room_number, req.checkin_date, req.checkout_date, req.ssn_customer))
